...
----
The `orion` database is for an empty `fiware-service`. For more examples and further reading click at this link: https://fiware-academy.readthedocs.io/en/latest/core/index.html
